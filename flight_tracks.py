...
# Init logger
if os.path.exists(SCRIPT_DIR / LOGGER_FILE):
    os.remove(SCRIPT_DIR / LOGGER_FILE)
...
def main():
    ...
    try:
        # Get flight tracking request payload
        json_string = sys.argv[1]
        logger.info("flight_tracks: config:" + json_string)
        ...
        logger.info("flight_tracks: flight count: " + str(len(results)))
        logger.debug("flight_tracks: flights:" + flights)
        print (flights)
